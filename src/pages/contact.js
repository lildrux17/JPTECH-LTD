    ...
    <main class="flex-grow bg-[#f7f9fb] text-[#191c1e] font-sans">
      ...
      <section class="relative bg-[#000615] py-24 px-6 overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto text-center md:text-left">
          ...
          <p class="text-base md:text-lg text-slate-300 max-w-2xl leading-relaxed">
      ...
      <section class="max-w-7xl mx-auto py-20 px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div class="lg:col-span-5 space-y-6">
          <div>
            ...
            <p class="text-base md:text-lg text-[#44474d] leading-relaxed">
          ...
          <div class="p-5 bg-white border border-slate-200 rounded-[0.25rem] shadow-sm flex items-center gap-4">
            ...
            <div>
              <span class="text-sm font-bold uppercase text-slate-400 block tracking-wider mb-0.5">Email Us</span>
              <a href="mailto:jptech67@gmail.com" class="text-sm font-black text-[#000615] tracking-tight hover:underline">jptech67@gmail.com</a>
            </div>
          </div>
          ...
          <div class="p-5 bg-white border border-slate-200 rounded-[0.25rem] shadow-sm flex items-center gap-4">
            ...
            <div>
              <span class="text-sm font-bold uppercase text-slate-400 block tracking-wider mb-0.5">Regional Office</span>
              <p class="text-sm font-black text-[#000615] uppercase tracking-tight leading-tight">Tarkwa, Ghana</p>
              <span class="text-sm text-[#44474d] block">West African Industrial Hub</span>
            </div>
          </div>
        ...
        <div class="lg:col-span-7 bg-white border border-slate-200 rounded-[0.25rem] shadow-sm p-8 relative">
          ...
          <form class="space-y-4" onsubmit="handleContactSubmit(event)">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <div class="absolute inset-y-0 right-3 flex items-center pointer-events-none text-slate-400 text-sm">▼</div>
                </div>
              </div>
            </div>
            ...
            <div class="text-center pt-2">
              <span class="text-sm font-medium text-slate-400">Typical response time: <strong class="text-[#855300]">2-4 business hours</strong></span>
            </div>
      ...
      <section class="max-w-7xl mx-auto px-6 pb-20">
        <div class="relative rounded-[0.25rem] overflow-hidden border border-slate-200 shadow-sm bg-slate-200 h-80">
          ...
          <div class="absolute bottom-6 left-6 max-w-sm bg-[#000615]/95 border border-slate-800 p-6 rounded-[0.15rem] text-white z-10 shadow-lg">
            <h4 class="text-lg font-black uppercase tracking-tight mb-1">Visit Our Site</h4>
