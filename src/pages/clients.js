    ...
    <main class="flex-grow bg-[#f7f9fb] text-[#191c1e] font-sans">
      ...
      <section class="relative bg-[#000615] pt-28 pb-24 px-6 text-white text-center md:text-left overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto">
          <span class="inline-block text-sm font-bold tracking-widest text-[#fea619] uppercase bg-white/5 border border-[#fea619]/20 px-3 py-1 rounded-[0.15rem] mb-4">
            Global Partnership
          </span>
          ...
          <p class="text-base md:text-lg text-slate-300 max-w-2xl leading-relaxed mb-8">
          ...
          <div class="flex items-center gap-6 border-t border-slate-800 pt-6 max-w-md mx-auto md:mx-0">
            <div>
              ...
              <span class="text-sm font-bold text-slate-400 uppercase tracking-wider block">Years of Expertise</span>
            </div>
            <div class="h-8 w-px bg-slate-800"></div>
            <div>
              <span class="text-xl md:text-2xl font-black text-white">20+</span>
              <span class="text-sm font-bold text-slate-400 uppercase tracking-wider block">Successful Projects</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="max-w-7xl mx-auto py-20 px-6">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
          <div>
            ...
            <p class="text-base md:text-lg text-[#44474d] max-w-2xl leading-relaxed">
          ...
          <div class="flex flex-wrap gap-2">
            <span class="px-3 py-1.5 bg-white border border-slate-200 text-sm font-bold uppercase tracking-wider text-[#44474d] rounded-[0.15rem]">Mining</span>
            <span class="px-3 py-1.5 bg-white border border-slate-200 text-sm font-bold uppercase tracking-wider text-[#44474d] rounded-[0.15rem]">Engineering</span>
            <span class="px-3 py-1.5 bg-white border border-slate-200 text-sm font-bold uppercase tracking-wider text-[#44474d] rounded-[0.15rem]">Infrastructure</span>
          </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div class="lg:col-span-6 relative rounded-[0.25rem] overflow-hidden shadow-md h-80 bg-slate-900">
            ...
            <div class="absolute bottom-4 left-4 right-4 bg-[#000615]/95 border border-slate-800 p-5 rounded-[0.15rem] text-white">
              ...
              <p class="text-sm text-slate-300 leading-relaxed mb-3">A multi-phase partnership with Mediterranean Project Limited.</p>
              <div class="flex items-center gap-1.5 text-sm font-mono uppercase tracking-wider text-emerald-400 font-bold">
          ...
          <div class="lg:col-span-6">
            <h2 class="text-3xl md:text-4xl font-black text-[#000615] uppercase tracking-tight mb-6">Beyond Just Service Delivery</h2>
            
            <div class="space-y-6">
              <div>
                <h4 class="text-sm font-bold text-[#000615] uppercase tracking-wider mb-1">Strategic Alignment</h4>
              ...
              <div>
                <h4 class="text-sm font-bold text-[#000615] uppercase tracking-wider mb-1">Technical Integrity</h4>
                <p class="text-sm md:text-base text-[#44474d] leading-relaxed">
      ...
      <section class="bg-[#000615] py-20 px-6 text-center text-white">
        <div class="max-w-3xl mx-auto">
          <h3 class="text-3xl md:text-4xl font-black uppercase tracking-tight mb-3">
          ...
          <div class="flex flex-wrap justify-center gap-4">
            <a href="/contact" data-link class="px-6 py-3 bg-[#fea619] hover:bg-[#e09110] text-[#000615] text-sm font-bold uppercase tracking-wider rounded-[0.25rem] transition-colors shadow-sm">
              Work With Us
            </a>
            <a href="/services" data-link class="px-6 py-3 bg-transparent hover:bg-white/5 border border-white/20 text-white text-sm font-bold uppercase tracking-wider rounded-[0.25rem] transition-colors">
              Our Services
            </a>
          </div>
        </div>
